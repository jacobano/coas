...
private:
  ...
  // Publishers
  ros::Publisher pub, pub_marker1, pub_marker2, pub_marker3;
  ...
  geometry_msgs::PoseStamped prevPost1, prevPost2, prevPost3, nowPost1, nowPost2, nowPost3;

  // Markers
  visualization_msgs::Marker marker_post1, marker_post2, marker_post3;
};